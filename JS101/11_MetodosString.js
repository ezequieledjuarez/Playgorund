...
/*
Completar URL
Crea una función llamada dominio que recibirá un String como "digitalhouse.com.ar" y su función será devolver "http://www.digitalhouse.com.ar".
 */

function dominio(texto){
  let agregar = 'http://www.'
  let final = agregar.concat(agregar,texto)
  return final
}
...
Lo primero que necesitas es declarar una variable llamada "texto" asignándole como valor un texto, el que vos quieras. Luego, utilizando la propiedad length tendrás que imprimir en consola el total de caracteres que contiene la frase.
 */
...
/*
Reemplazo fast fast
Tu misión ahora es crear una funcion llamada "reemplazoFastFast" que reciba un texto, una palabra a buscar y la palabra que va a reemplazar a la buscada. La función deberá devolver el texto con la palabra reemplazada.
